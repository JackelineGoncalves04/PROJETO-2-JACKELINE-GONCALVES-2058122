<template>
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="d-flex flex-row align-items-center">
                        ...
                        <a href="#!" style="color: #cecece;"  @click="removeFromCart(index)"><i class="fas fa-trash-alt" ></i></a>
                      
                      </div>
                    </div>
                  </div>
                </div>
                <div v-else class="text-light d-flex flex-column justify-content-center align-items-center pt-5 fw-bold fs-5"> Car is empty 
                  <img class="car_empty w-25 h-25 my-auto " src="../assets/img/carrito-de-compras.png"/>
                </div>
              </div>
              <div class="col-lg-5">
                ...
                <div class="card bg-primary text-white rounded-3">
                  <div class="card-body " style="background-color: rgb(79, 57, 125)" >
                    ...
                    <div class="d-flex justify-content-between mb-4">
                      ...
                      <p class="mb-2"> {{ ShoppingStore.calculateTotalPrice() }}$</p>
                    </div>
  ...
  const removeFromCart = (index) => {
    ShoppingStore.arrayShopping.splice(index, 1);
  };
</script>
